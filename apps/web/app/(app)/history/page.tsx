...
export default function HistoryPage() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-bg-base">
      ...
      <div className="mx-4 mt-4 bg-accent-subtle border border-accent-border rounded-[10px] p-4 flex items-start gap-3">
      ...
      {/* Empty state */}
      <main className="flex-1 flex flex-col items-center justify-center pb-20 gap-4 px-4">

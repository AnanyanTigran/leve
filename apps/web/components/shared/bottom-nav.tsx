  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-50 bg-bg-base border-t border-border-default pb-[var(--safe-area-inset-bottom)]">
      <div className="flex items-center justify-around h-16">
        {/* Home */}
        <Link href="/" className="flex flex-col items-center justify-center flex-1 h-full">
          <Home
        ...
        <Link href="/upload" className="flex flex-col items-center justify-center flex-1 h-full">
        ...
        {/* History */}
        <Link href="/history" className="flex flex-col items-center justify-center flex-1 h-full">
          <Clock
            className={cn(
